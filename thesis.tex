...
\include{Chapter1/context}
%\include{Chapter1/contribution}
%\include{Chapter1/overview}

\chapter{Background}
\label{ch:background}
%\include{Chapter2/elevators}
\include{Chapter2/nns}
%\include{Chapter2/csp}
%\include{Chapter2/genetic}
...
\include{Chapter4/abstraction}
%\include{Chapter4/optimization}
...
\include{Chapter5/bound_propagation_types}
\include{Chapter5/relu_overapproximation}
%\include{Chapter4/cegar}
%
%\chapter{PyNeVer BP Application}
\label{ch:bp-application}
\include{Chapter6/bound_propagation_pynever_application}
\include{Chapter6/future}

\chapter{Bound Propagation Pseudocode}
\label{ch:bp-pseudocode}
\include{Chapter7/bound_propagation_pseudocode}
\include{Chapter7/bound_propagation_test_results}

%\chapter{NeVerTools: \coconet{} and \nevertwo{}}
%\label{ch:never2}
%\include{Chapter5/coconet}
%\include{Chapter5/never2}

%\chapter{Experimental analysis}
%\label{ch:experiments_nn}
%\include{Chapter5/case_studies}
